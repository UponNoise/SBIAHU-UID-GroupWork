...
redraw();
    ...
    function createUi()
        ...
        uicontrol(app.header, 'Style', 'text', ...
            ...
            'String', 'ISE 333 Campus Navigation', ...
        ...
        uicontrol(app.header, 'Style', 'text', ...
            ...
            'String', 'Map | IV | Road Model | Path | Street View', ...
            'HorizontalAlignment', 'left', ...
            'BackgroundColor', [0.02 0.34 0.62], ...
        ...
        uicontrol(app.header, 'Style', 'text', ...
            ...
            'String', 'Stony Brook University  ISE333', ...
        ...
        app.panel = uipanel('Parent', app.fig, ...
            ...
            'Title', 'Campus Navigation Controls', ...
    ...
    function createStreetView(pt)
        ...
        text(50, 60, 'Virtual Street View', 'Parent', ax, ...
            'HorizontalAlignment', 'center', 'FontWeight', 'bold', 'FontSize', 14, ...
            'Color', [0.04 0.20 0.32]);
        text(50, 56, sprintf('X %.1f m, Y %.1f m | heading %.1f deg | road width %.1f m', ...
        ...
        function drawCompassInset(angleDeg)
            ...
            text(cx, cy - 7.2, 'Heading', 'Parent', ax, 'HorizontalAlignment', 'center', ...
